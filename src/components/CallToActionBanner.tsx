        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0">
            <button
              ...
              className="w-full sm:w-auto px-7 py-4 bg-[#F5C51B] hover:bg-[#e0b213] text-[#0A1622] font-bold text-sm rounded-lg shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2 cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-7 py-4 bg-white/10 hover:bg-white/20 text-white font-bold text-sm rounded-lg border border-white/20 transition-all duration-300 flex items-center justify-center space-x-2 cursor-pointer backdrop-blur-md"
            >
